...
class FileDaoImpl : io.github.hummel009.discord.prokhor.dao.FileDao {
	...
	override fun getFile(filePath: String): File = File(_root_ide_package_.io.github.hummel009.discord.prokhor.bean.BotData.root, filePath)

	override fun getFolder(folderPath: String): File = File(_root_ide_package_.io.github.hummel009.discord.prokhor.bean.BotData.root, folderPath)
